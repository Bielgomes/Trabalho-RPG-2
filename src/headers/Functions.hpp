...
class Functions {
    public:
        ...
        static sf::Vector2f directionTo(float angle);
        static sf::Vector2f directionTo(sf::Vector2f from, sf::Vector2f to);
        static sf::Vector2f directionTo(float from_x, float from_y, float to_x, float to_y);
};